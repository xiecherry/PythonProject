...
class MyTestCase(unittest.TestCase):
    def setUp(self) :
        ...
        # 点击进口报关单审核
        elem5 = self.driver.find_element_by_xpath('//*[@id="nav-left"]/li[3]/dl/dd[2]/dl/dd[5]/a/cite')
    ...
    def test_12_form_verify(self):
        ...
        time.sleep(1)
        #点击快速审核按钮
        self.driver.find_element_by_xpath('//*[@id="auditSubmitBtn"]').click()
        time.sleep(1)
        # 点击确定按钮
        self.driver.find_element_by_xpath('/html/body/div[3]/div[3]/a[1]').click()
        time.sleep(1)
        # 截图
        self.driver.get_screenshot_as_file("D:\\PythonProject\\Cherry_Discover\\Image\\form_verify.png")
