...
class MyTestCase(unittest.TestCase):
    ...
    def test_8_copy(self):
        ...
        time.sleep(1)
        # 点击复制按钮
        self.driver.find_element_by_xpath('/html/body/div[2]/div[1]/div[1]/div/button[3]').click()
        time.sleep(1)

        # 点击复制表头按钮
        self.driver.find_element_by_xpath('/html/body/div[3]/div[2]/div/div/button[1]').click()
        time.sleep(2)
        # 截图
        self.driver.get_screenshot_as_file("D:\\PythonProject\\Cherry_Discover\\Image\\copy.png")
        time.sleep(2)
        # 点击确定按钮
