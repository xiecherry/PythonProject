...
class MyTestCase(unittest.TestCase):
    ...
    def test_6_generate_bill(self):
        ...
        # 点击弹框确定按钮
        self.driver.find_element_by_xpath('/html/body/div[8]/div[3]/a[1]').click()
        time.sleep(2)
        ...
        time.sleep(2)
        # 截图
        self.driver.get_screenshot_as_file("D:\\PythonProject\\Cherry_Discover\\Image\\generate_bill.png")
        time.sleep(2)
        # ============================
