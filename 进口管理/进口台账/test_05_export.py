...
class MyTestCase(unittest.TestCase):
    ...
    def test_5_export(self):
        ...
        # 点击导出按钮
        elem42 = self.driver.find_element_by_xpath('/html/body/div[2]/div[1]/div/div[2]/button[7]')
        ActionChains(self.driver).click(elem42).perform()
        self.driver.get_screenshot_as_file("D:\\PythonProject\\Cherry_Discover\\Image\\export.png")
        time.sleep(2)
