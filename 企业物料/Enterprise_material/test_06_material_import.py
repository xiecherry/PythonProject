...
class MyTestCase(unittest.TestCase):
    ...
    # 具体的测试用例，一定要以test开头
    def test_6_material_import(self):
        ...
        print(current_dir)
        path_to_excel = os.path.join(current_dir,"导入模板_新增物料申请.xlsx")
        # 选择文件
        ...
        self.driver.implicitly_wait(5)
        self.driver.get_screenshot_as_file(r".\Material_Image\material_import.png")
