...
class MyTestCase(unittest.TestCase):
    ...
    def test_1_create(self):
        ...
        self.driver.implicitly_wait(2)
        # 选种一条数据
        elem16 = self.driver.find_element_by_xpath(
            '/html/body/div[2]/div[2]/div[3]/div[2]/table/tbody/tr[1]/td[1]/div/div/i')
        ActionChains(self.driver).click(elem16).perform()
        time.sleep(2)
        # 点击编辑按钮
        elem7 = self.driver.find_element_by_xpath(
            '/html/body/div[2]/div[2]/div[4]/div[2]/table/tbody/tr[1]/td/div/button[1]/i')
        ...
        if elem22_date == "slider open":
            self.driver.execute_script('arguments[0].setAttribute(arguments[1],arguments[2])', elem22,'class','slider close')
            ...
            if elem24_date=="display: block;":
                self.driver.execute_script('arguments[0].setAttribute(arguments[1],arguments[2])',elem24,'style','display: none;')
