...
class MyTestCase(unittest.TestCase):
    ...
    def test_13_enterprise_material_apply(self):
        # ====================================================表头==============================================
        # 再定位新的iframe
        ...
        time.sleep(1)
        #点击发起申请按钮
        elem17 =self.driver.find_element_by_xpath('/html/body/div[2]/div[1]/div[1]/div/button[1]')
        ActionChains(self.driver).click(elem17).perform()
        time.sleep(1)
        #点击确定按钮
        elem18 = self.driver.find_element_by_xpath('/html/body/div[3]/div[3]/a[1]')
