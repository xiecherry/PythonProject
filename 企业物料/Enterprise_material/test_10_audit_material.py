...
class MyTestCase(unittest.TestCase):
    ...
    # 具体的测试用例，一定要以test开头
    def test_10_audit_material(self):
        ...
        #点击审核按钮
        elem17 = self.driver.find_element_by_xpath('/html/body/div[2]/div[1]/div[1]/div/button[2]')
        ActionChains(self.driver).click(elem17).perform()
        time.sleep(2)

        # 点击确定按钮
        elem17 = self.driver.find_element_by_xpath('//*[@id="layui-layer2"]/div[3]/a[1]')
        ActionChains(self.driver).click(elem17).perform()
        time.sleep(2)
