...
class Customs_broker_Search(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_search(self):
        ...
        # 查询
        self.dr.find_element(By.ID,"agentCode").send_keys('A003')
        self.dr.find_element(By.ID,"tradeCode").send_keys('1234884222')
